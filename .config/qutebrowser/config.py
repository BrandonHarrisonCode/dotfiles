...
config.bind('<Ctrl-b>', 'set-cmd-text -s :quickmark-load -t')
config.bind('<Ctrl-d>', 'tab-close -o')
config.bind('<Ctrl-f>', 'hint all tab')
config.bind('<Ctrl-g>', 'scroll-to-perc')
...
config.bind('<Ctrl-p><Ctrl-p>', 'open -t -- {primary}')
config.bind('<Ctrl-p>p', 'open -t -- {clipboard}')
config.bind('<Ctrl-r>', 'reload -f')
config.bind('<Ctrl-s>b', 'open qute://bookmarks#bookmarks')
config.bind('<Ctrl-s>h', 'open qute://history')
config.bind('<Ctrl-s>q', 'open qute://bookmarks')
config.bind('<Ctrl-s>s', 'open qute://settings')
config.bind('<Ctrl-t>', 'tab-focus')
config.bind('<Ctrl-z><Ctrl-q>', 'quit')
config.bind('<Ctrl-z><Ctrl-z>', 'quit --save')
...
config.bind('g<Ctrl-b>', 'set-cmd-text -s :bookmark-load -t')
config.bind('g<Ctrl-c>', 'tab-clone')
config.bind('g<Ctrl-o>', 'set-cmd-text :open -t -r {url:pretty}')
config.bind('g<Ctrl-u>', 'navigate up -t')
# config.bind('g^', 'tab-focus 1')
...
config.bind('p<Ctrl-p>', 'open -- {primary}')
...
config.bind('t<Ctrl-p><Ctrl-h>', 'config-cycle -p -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('t<Ctrl-p>h', 'config-cycle -p -u *://{url:host}/* content.plugins ;; reload')
config.bind('t<Ctrl-p>u', 'config-cycle -p -u {url} content.plugins ;; reload')
config.bind('t<Ctrl-s><Ctrl-h>', 'config-cycle -p -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('t<Ctrl-s>h', 'config-cycle -p -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('t<Ctrl-s>u', 'config-cycle -p -u {url} content.javascript.enabled ;; reload')
# config.bind('th', 'back -t')
# config.bind('tl', 'forward -t')
config.bind('tp<Ctrl-h>', 'config-cycle -p -t -u *://*.{url:host}/* content.plugins ;; reload')
# config.bind('tph', 'config-cycle -p -t -u *://{url:host}/* content.plugins ;; reload')
# config.bind('tpu', 'config-cycle -p -t -u {url} content.plugins ;; reload')
config.bind('ts<Ctrl-h>', 'config-cycle -p -t -u *://*.{url:host}/* content.javascript.enabled ;; reload')
# config.bind('tsh', 'config-cycle -p -t -u *://{url:host}/* content.javascript.enabled ;; reload')
# config.bind('tsu', 'config-cycle -p -t -u {url} content.javascript.enabled ;; reload')
# config.bind('u', 'undo')
# config.bind('v', 'enter-mode caret')
config.bind('w<Ctrl-b>', 'set-cmd-text -s :bookmark-load -w')
config.bind('w<Ctrl-o>', 'set-cmd-text :open -w {url:pretty}')
config.bind('w<Ctrl-p>', 'open -w -- {primary}')
...
config.bind('x<Ctrl-o>', 'set-cmd-text :open -b -r {url:pretty}')
# config.bind('xo', 'set-cmd-text -s :open -b')
config.bind('y<Ctrl-d>', 'yank domain -s')
config.bind('y<Ctrl-p>', 'yank pretty-url -s')
config.bind('y<Ctrl-t>', 'yank title -s')
config.bind('y<Ctrl-y>', 'yank -s')
